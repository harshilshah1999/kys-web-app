<template>
  <v-card elevation="2" outlined>
    <v-card-title>Add a New Volunteer</v-card-title>
    <v-divider></v-divider>
    <v-card-text>
      <v-form
        v-model="valid"
...
export default {
  ...
  computed: {
    formattedDateOfBirth: function () {
      return this.formatDate(this.volunteer.date_of_birth);
    },
    formattedRegistrationDate: function () {
      return this.formatDate(this.volunteer.registration_date);
    },
    formattedExpirationDate: function () {
      return this.formatDate(this.volunteer.expiration_date);
    },
  },
  watch: {
    menu(val) {
